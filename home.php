...
<head>
    ...
    <title>Home | Justice Voice</title>
  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This Justice Voice is developed by <span style="font-weight: 700;">A2Z developer</span>  for learning purpose.</p>
        ...
        <div class="sidebar-left">
          <div  class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img id="logo" src="<?php echo BASE_URL . "jc.png"; ?>" alt="" height="80px" width="80px" margin />
            </div>
          </div>
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <span class="bioCount" id="count" style="color: #f21d1d !important;">500</span>
                            <input id="tweet-input" type="submit" name="tweet" value="Voice" class="submit" 
                            >
                          </div>
                      </div>
                      </form>
